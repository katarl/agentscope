...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    Jarvis: {
        "type": "tool_use",
        "id": "call_19597add97dd48ef99ae87",
    ...
    Jarvis: {
        "type": "tool_use",
        "id": "call_a6e8aeacdd654b06bcb422",
        "name": "example_tool_function",
        "input": {
            "tag": "tag2"
        }
    ...
    system: {
        ...
        "output": [
            {
                "type": "text",
                "text": "标签 tag1 开始于 15:48:01.539739，结束于 15:48:04.543031。"
            }
        ]
    }
    system: {
        ...
        "output": [
            {
                "type": "text",
                "text": "标签 tag2 开始于 15:48:01.539838，结束于 15:48:04.543736。"
            }
        ]
    }
    Jarvis: 两个 `example_tool_function` 函数已经并行执行完毕。下面是它们各自的运行时间：

    - 标签为 'tag1' 的函数从 15:48:01.539739 开始，在 15:48:04.543031 结束。
    - 标签为 'tag2' 的函数从 15:48:01.539838 开始，在 15:48:04.543736 结束。

    这两个函数几乎是同时开始和结束的，表明它们确实被并行调用了。
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    Jarvis: {
        "type": "tool_use",
        "id": "call_760d4c9744a04b4f89bdf0",
    ...
    Jarvis: 阿尔伯特·爱因斯坦（Albert Einstein, 1879-1955）是20世纪最伟大的理论物理学家之一，以其相对论的创立而闻名于世。他的工作彻底改变了我们对时间、空间以及引力的理解，并为现代物理学的发展奠定了基础。爱因斯坦出生于德国的一个犹太家庭，在他的一生中，不仅在科学领域取得了巨大成就，还积极投身于和平主义和社会正义活动中。

    爱因斯坦最重要的贡献之一是他提出的特殊相对论（1905年）和广义相对论（1915年）。这些理论不仅挑战了牛顿力学体系下关于宇宙的传统观念，而且预言了许多后来被实验证实的现象，如光线弯曲、水星轨道进动等。此外，他还提出了著名的质能方程E=mc²，揭示了质量与能量之间深刻的联系。

    除了其科学上的成就外，爱因斯坦也因其人道主义精神而受到尊敬。他利用自己的名声来支持各种社会事业，并且是一位坚定的反战主义者。爱因斯坦获得了许多荣誉，包括1921年的诺贝尔物理学奖，以表彰他对理论物理学的贡献，特别是光电效应定律的发现；普朗克奖章，这是德国物理学会颁发给杰出物理学家的一项荣誉；以及美国富兰克林研究所授予的富兰克林奖章，旨在认可他在科学领域的卓越贡献。直到今天，爱因斯坦的名字依然是智慧与创新精神的象征。
