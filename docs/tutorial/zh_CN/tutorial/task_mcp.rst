...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    /usr/lib/python3.10/contextlib.py:103: DeprecationWarning: Use `streamable_http_client` instead.
...
.. rst-class:: sphx-glr-script-out
 ...
 .. code-block:: none
    ...
    函数调用结果：
    ToolResponse(content=[{'type': 'text', 'text': 'API 调用失败：INVALID_USER_KEY'}], metadata=None, stream=False, is_last=True, is_interrupted=False, id='2026-01-31 15:50:42.973_8bbcff')
