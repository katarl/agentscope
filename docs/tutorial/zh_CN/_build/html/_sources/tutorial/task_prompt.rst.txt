...
.. code-block:: pytb
    ...
    Traceback (most recent call last):
      File "/opt/agent/agentscope/docs/tutorial/zh_CN/src/task_prompt.py", line 269, in <module>
        n_tokens = asyncio.run(run_token_counter())
      File "/usr/lib/python3.10/asyncio/runners.py", line 44, in run
        return loop.run_until_complete(main)
      File "/usr/lib/python3.10/asyncio/base_events.py", line 649, in run_until_complete
        return future.result()
      File "/opt/agent/agentscope/docs/tutorial/zh_CN/src/task_prompt.py", line 261, in run_token_counter
        token_counter = HuggingFaceTokenCounter(
      File "/opt/agent/agentscope/src/agentscope/token/_huggingface_token_counter.py", line 40, in __init__
...
.. GENERATED FROM PYTHON SOURCE LINES 299-336
